...
$tempdir = sys_get_temp_dir() ;
  $descriptorspec = array(
       ...
       2 => array("file", $tempdir.'/test.txt', "a")
       );

  //$cmd = " dot -T".$type;
 $dotpath = realpath("../../../bin/other/Graphviz/bin/dot.exe") ;
  $cmd = '"'.$dotpath.'" -T'.$type;
//  echo realpath("../../../bin/other/Graphviz/bin/dot.exe") ;//
  $process = proc_open($cmd, $descriptorspec, $pipes, "$tempdir", array());
